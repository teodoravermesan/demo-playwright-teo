...
export declare class NbMenuItemComponent implements DoCheck, AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbMenuItemComponent, "[nbMenuItem]", never, { "menuItem": "menuItem"; "badge": "badge"; }, { "hoverItem": "hoverItem"; "toggleSubMenu": "toggleSubMenu"; "selectItem": "selectItem"; "itemClick": "itemClick"; }, never, never, false>;
}
/**
...
export declare class NbMenuComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbMenuComponent, "nb-menu", never, { "tag": "tag"; "items": "items"; "autoCollapse": "autoCollapse"; }, {}, never, never, false>;
}
