...
export declare class NbCardHeaderComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbCardHeaderComponent, "nb-card-header", never, {}, {}, never, ["*"], false>;
}
/**
 * Component intended to be used within  the `<nb-card>` component.
...
export declare class NbCardBodyComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbCardBodyComponent, "nb-card-body", never, {}, {}, never, ["*"], false>;
}
/**
 * Component intended to be used within  the `<nb-card>` component.
...
export declare class NbCardFooterComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbCardFooterComponent, "nb-card-footer", never, {}, {}, never, ["*"], false>;
}
/**
...
export declare class NbCardComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbCardComponent, "nb-card", never, { "size": "size"; "status": "status"; "accent": "accent"; }, {}, never, ["nb-card-header", "nb-card-body", "*", "nb-card-footer"], false>;
}
