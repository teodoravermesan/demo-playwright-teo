...
export declare class NbRevealCardComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbRevealCardComponent, "nb-reveal-card", never, { "revealed": "revealed"; "showToggleButton": "showToggleButton"; }, {}, never, ["nb-card-front", "nb-card-back"], false>;
}
