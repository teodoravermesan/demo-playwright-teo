...
export declare class NbFlipCardComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbFlipCardComponent, "nb-flip-card", never, { "flipped": "flipped"; "showToggleButton": "showToggleButton"; }, {}, never, ["nb-card-front", "nb-card-back"], false>;
}
