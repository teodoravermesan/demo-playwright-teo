...
export declare class NbLayoutComponent implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbLayoutComponent, "nb-layout", never, { "center": "center"; "windowMode": "windowMode"; "withScroll": "withScroll"; "restoreScrollTop": "restoreScrollTop"; }, {}, never, ["nb-layout-header:not([subheader])", "nb-sidebar", "nb-layout-header[subheader]", "nb-layout-column", "nb-layout-footer"], false>;
}
/**
...
export declare class NbLayoutColumnComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbLayoutColumnComponent, "nb-layout-column", never, { "left": "left"; "start": "start"; }, {}, never, ["*"], false>;
}
/**
...
export declare class NbLayoutHeaderComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbLayoutHeaderComponent, "nb-layout-header", never, { "fixed": "fixed"; "subheader": "subheader"; }, {}, never, ["*"], false>;
}
/**
 * Page footer.
...
export declare class NbLayoutFooterComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbLayoutFooterComponent, "nb-layout-footer", never, { "fixed": "fixed"; }, {}, never, ["*"], false>;
}
