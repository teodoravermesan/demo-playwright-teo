...
export declare class NbButtonGroupComponent implements OnChanges, AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbButtonGroupComponent, "nb-button-group", never, { "size": "size"; "status": "status"; "shape": "shape"; "appearance": "appearance"; "disabled": "disabled"; "multiple": "multiple"; "filled": "filled"; "outline": "outline"; "ghost": "ghost"; }, { "valueChange": "valueChange"; }, ["buttons"], ["*"], false>;
}
