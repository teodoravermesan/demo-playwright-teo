...
export declare class NbAccordionItemHeaderComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbAccordionItemHeaderComponent, "nb-accordion-item-header", never, {}, {}, never, ["nb-accordion-item-title", "nb-accordion-item-description", "*"], false>;
}
