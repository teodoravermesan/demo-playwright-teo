...
export declare class NbTagListComponent implements OnInit, AfterContentInit, AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbTagListComponent, "nb-tag-list", ["nbTagList"], { "size": "size"; "tabIndex": "tabIndex"; "role": "role"; "multiple": "multiple"; }, { "tagRemove": "tagRemove"; }, ["tagInput", "autocompleteDirective", "tags"], ["nb-tag, input[nbTagInput]"], false>;
}
