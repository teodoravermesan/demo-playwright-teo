...
export declare class NbTagComponent implements AfterViewInit, OnDestroy, NbHighlightableOption {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbTagComponent, "nb-tag", ["nbTag"], { "text": "text"; "selected": "selected"; "removable": "removable"; "appearance": "appearance"; "status": "status"; "size": "size"; "role": "role"; }, { "remove": "remove"; "selectedChange": "selectedChange"; }, never, never, false>;
}
