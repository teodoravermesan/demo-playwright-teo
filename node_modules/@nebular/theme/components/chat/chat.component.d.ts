...
export declare class NbChatComponent implements OnChanges, AfterContentInit, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbChatComponent, "nb-chat", never, { "title": "title"; "size": "size"; "status": "status"; "noMessagesPlaceholder": "noMessagesPlaceholder"; "scrollBottom": "scrollBottom"; }, {}, ["chatForm", "titleTemplate", "messages"], ["nb-chat-message", "nb-chat-form"], false>;
}
