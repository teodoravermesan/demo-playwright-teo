...
export declare class NbSortDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbSortDirective, "[nbSort]", never, { "sortable": "nbSort"; }, { "sort": "sort"; }, never, never, false>;
}
...
export declare class NbSortHeaderIconDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbSortHeaderIconDirective, "[nbSortHeaderIcon]", never, {}, {}, never, never, false>;
}
export declare class NbSortIconComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbSortIconComponent, "nb-sort-icon", never, { "direction": "direction"; }, {}, never, never, false>;
}
/**
...
export declare class NbSortHeaderComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbSortHeaderComponent, "[nbSortHeader]", never, { "direction": "nbSortHeader"; "disabled": "disabled"; }, {}, ["sortIcon"], ["*"], false>;
}
export {};
