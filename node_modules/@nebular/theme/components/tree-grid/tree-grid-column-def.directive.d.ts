...
export declare class NbTreeGridColumnDefDirective extends NbColumnDefDirective implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbTreeGridColumnDefDirective, "[nbTreeGridColumnDef]", never, { "name": "nbTreeGridColumnDef"; "hideOn": "hideOn"; "showOn": "showOn"; }, {}, never, never, false>;
}
