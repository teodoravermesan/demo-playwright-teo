...
export declare class NbTreeGridComponent<T> extends NbTable<NbTreeGridPresentationNode<T>> implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbTreeGridComponent<any>, "table[nbTreeGrid]", never, { "source": "nbTreeGrid"; "levelPadding": "levelPadding"; "equalColumnsWidth": "equalColumnsWidth"; }, {}, never, never, false>;
}
