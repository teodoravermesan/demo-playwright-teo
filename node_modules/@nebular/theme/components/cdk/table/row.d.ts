...
export declare class NbDataRowOutletDirective extends DataRowOutlet {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbDataRowOutletDirective, "[nbRowOutlet]", never, {}, {}, never, never, false>;
}
export declare class NbHeaderRowOutletDirective extends HeaderRowOutlet {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbHeaderRowOutletDirective, "[nbHeaderRowOutlet]", never, {}, {}, never, never, false>;
}
export declare class NbFooterRowOutletDirective extends FooterRowOutlet {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbFooterRowOutletDirective, "[nbFooterRowOutlet]", never, {}, {}, never, never, false>;
}
export declare class NbNoDataRowOutletDirective extends NoDataRowOutlet {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbNoDataRowOutletDirective, "[nbNoDataRowOutlet]", never, {}, {}, never, never, false>;
}
export declare class NbCellOutletDirective extends CdkCellOutlet {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbCellOutletDirective, "[nbCellOutlet]", never, {}, {}, never, never, false>;
}
/**
...
export declare class NbHeaderRowDefDirective extends CdkHeaderRowDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbHeaderRowDefDirective, "[nbHeaderRowDef]", never, { "columns": "nbHeaderRowDef"; "sticky": "nbHeaderRowDefSticky"; }, {}, never, never, false>;
}
/**
...
export declare class NbFooterRowDefDirective extends CdkFooterRowDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbFooterRowDefDirective, "[nbFooterRowDef]", never, { "columns": "nbFooterRowDef"; "sticky": "nbFooterRowDefSticky"; }, {}, never, never, false>;
}
/**
...
export declare class NbRowDefDirective<T> extends CdkRowDef<T> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbRowDefDirective<any>, "[nbRowDef]", never, { "columns": "nbRowDefColumns"; "when": "nbRowDefWhen"; }, {}, never, never, false>;
}
...
export declare class NbHeaderRowComponent extends CdkHeaderRow {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbHeaderRowComponent, "nb-header-row, tr[nbHeaderRow]", never, {}, {}, never, never, false>;
}
/** Footer template container that contains the cell outlet. Adds the right class and role. */
export declare class NbFooterRowComponent extends CdkFooterRow {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbFooterRowComponent, "nb-footer-row, tr[nbFooterRow]", never, {}, {}, never, never, false>;
}
...
export declare class NbRowComponent extends CdkRow {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbRowComponent, "nb-row, tr[nbRow]", never, {}, {}, never, never, false>;
}
