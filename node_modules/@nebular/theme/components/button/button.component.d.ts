...
export declare class NbButtonComponent extends NbButton implements AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbButtonComponent, "button[nbButton],a[nbButton],input[type=\"button\"][nbButton],input[type=\"submit\"][nbButton]", never, { "hero": "hero"; }, {}, never, ["*"], false>;
}
