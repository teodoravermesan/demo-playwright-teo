...
export declare class NbCalendarMonthPickerComponent<D, T> implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbCalendarMonthPickerComponent<any, any>, "nb-calendar-month-picker", never, { "min": "min"; "max": "max"; "filter": "filter"; "size": "size"; "month": "month"; "date": "date"; "_cellComponent": "cellComponent"; }, { "monthChange": "monthChange"; }, never, never, false>;
}
