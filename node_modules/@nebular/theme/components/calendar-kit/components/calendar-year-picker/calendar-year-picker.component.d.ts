...
export declare class NbCalendarYearPickerComponent<D> implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbCalendarYearPickerComponent<any>, "nb-calendar-year-picker", never, { "date": "date"; "min": "min"; "max": "max"; "filter": "filter"; "_cellComponent": "cellComponent"; "size": "size"; "year": "year"; }, { "yearChange": "yearChange"; }, never, never, false>;
}
