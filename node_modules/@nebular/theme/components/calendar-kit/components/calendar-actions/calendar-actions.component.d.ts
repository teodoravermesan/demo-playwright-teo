...
export declare class NbCalendarActionsComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbCalendarActionsComponent, "nb-calendar-actions", never, { "applyButtonText": "applyButtonText"; "currentTimeButtonText": "currentTimeButtonText"; "showCurrentTimeButton": "showCurrentTimeButton"; }, { "setCurrentTime": "setCurrentTime"; "saveValue": "saveValue"; }, never, never, false>;
}
