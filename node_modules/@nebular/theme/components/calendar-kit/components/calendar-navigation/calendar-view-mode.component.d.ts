...
export declare class NbCalendarViewModeComponent<D> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbCalendarViewModeComponent<any>, "nb-calendar-view-mode", never, { "date": "date"; "viewMode": "viewMode"; }, { "changeMode": "changeMode"; }, never, never, false>;
}
