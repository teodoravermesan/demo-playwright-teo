...
export declare class NbCalendarPageableNavigationComponent<D> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbCalendarPageableNavigationComponent<any>, "nb-calendar-pageable-navigation", never, {}, { "next": "next"; "prev": "prev"; }, never, never, false>;
}
