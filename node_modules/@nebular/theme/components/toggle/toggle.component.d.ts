...
export declare class NbToggleComponent implements OnInit, AfterViewInit, OnDestroy, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbToggleComponent, "nb-toggle", never, { "checked": "checked"; "disabled": "disabled"; "status": "status"; "labelPosition": "labelPosition"; }, { "checkedChange": "checkedChange"; }, never, ["*"], false>;
}
